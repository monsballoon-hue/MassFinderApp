...
window.openChaplet = chaplet.openChaplet;
window.closeChaplet = chaplet.closeChaplet;
window.chapletNext = chaplet.chapletNext;
window.chapletPrev = chaplet.chapletPrev;
window.openPrayerBook = prayerbook.openPrayerBook;
window.closePrayerBook = prayerbook.closePrayerBook;
window.prayerbookSearch = prayerbook.prayerbookSearch;
window.prayerbookToggle = prayerbook.prayerbookToggle;
window.prayerbookToggleFilter = prayerbook.prayerbookToggleFilter;
window.prayerbookToggleFav = prayerbook.prayerbookToggleFav;
window.prayerbookOpenLitany = prayerbook.prayerbookOpenLitany;
window.prayerbookOpenLectio = prayerbook.prayerbookOpenLectio;
window.prayerbookLitanyNext = prayerbook.prayerbookLitanyNext;
window.prayerbookLitanyPrev = prayerbook.prayerbookLitanyPrev;
window.prayerbookLitanyClose = prayerbook.prayerbookLitanyClose;
window.prayerbookLitanyBegin = prayerbook.prayerbookLitanyBegin;
...
window.openConfessionGuide = function() { reader.readerOpen('confession-guide'); };
...
window.novenaBeginPrayer = novena.novenaBeginPrayer;
