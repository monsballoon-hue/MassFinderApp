...
function _render() {
  ...
  html += '<div class="settings-group settings-about">'
    ...
    + '<p class="settings-about-text">Mass times, confession, devotions and parish events for Western New England \u2014 with prayer tools, daily readings and formation resources.</p>'
    + '</div>'
    ...
    + '<p class="settings-about-text" style="margin-bottom:var(--space-3)">Notice something outdated?</p>'
    + '<textarea id="settingsContactMsg" class="settings-contact-field" rows="3" placeholder="What needs updating?"></textarea>'
    + '<input id="settingsContactEmail" class="settings-contact-field" type="email" placeholder="Email (optional)" style="margin-top:var(--space-2)">'
    + '<div id="settingsContactThanks" style="display:none;font-size:var(--text-sm);color:var(--color-verified);margin-top:var(--space-2);padding:var(--space-2) 0"></div>'
    + '<button class="settings-contact-btn" onclick="submitSettingsContact()" style="margin-top:var(--space-3)">Send</button>'
    + '</div>'
    + '<div class="settings-about-block" style="margin-top:var(--space-4);padding-top:var(--space-3);border-top:1px solid var(--color-border-light)">'
