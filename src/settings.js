...
function _render() {
  ...
  html += '<div class="settings-group settings-about">'
    ...
    + '<p class="settings-about-text">Mass times, confession hours, and parish events for the Diocese of Springfield \u2014 with prayer tools, daily readings, and formation resources.</p>'
    + '</div>'
    ...
    + '<p class="settings-about-text">Notice something outdated? <a href="mailto:massfinderapp@gmail.com" style="color:var(--color-primary);text-decoration:none;font-weight:var(--weight-semibold)">massfinderapp@gmail.com</a></p>'
    + '</div>'
    + '<div class="settings-about-block" style="margin-top:var(--space-4);padding-top:var(--space-3);border-top:1px solid var(--color-border-light)">'
