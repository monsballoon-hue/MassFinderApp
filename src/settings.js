...
function _render() {
  ...
  html += '<div class="settings-group settings-about">'
    ...
    + '<p class="settings-about-text">MassFinder helps Catholics in Western New England find Mass times, confession hours, and community events across the Diocese of Springfield.</p>'
    + '<p class="settings-about-text" style="margin-top:var(--space-2)"><strong>Available now:</strong> Parish schedules, guided Rosary, Examination of Conscience, Stations of the Cross, Novena tracker, daily readings, and saints of the day.</p>'
    + '<p class="settings-about-text" style="margin-top:var(--space-2)"><strong>Coming soon:</strong> Bible reader, Catechism explorer, cross-references, and more prayer tools. We\u2019re building this step by step \u2014 stay tuned!</p>'
    + '</div>'
    ...
    + '<p class="settings-about-text" style="margin-top:var(--space-1)">We use AI to parse parish bulletins, but we need real parishioners to verify the data. Become a Parish Champion \u2014 adopt your church and help keep its schedule accurate for everyone.</p>'
    ...
    + '<p class="settings-about-text" style="margin-top:var(--space-2)"><a href="https://github.com/massfinder" target="_blank" rel="noopener" style="color:var(--color-primary);text-decoration:none;font-weight:var(--weight-semibold)">View on GitHub \u2192</a>'
