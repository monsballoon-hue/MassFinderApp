...
function _renderFirstFriday(bodyEl) {
  ...
  if (_ffTab === 'friday') {
    ...
    content = '<div style="border-left:3px solid var(--color-sacred);padding-left:var(--space-4);margin-bottom:var(--space-4)">'
      ...
      + '<div style="padding:var(--space-4);border:1px solid var(--color-border-light);border-top:none;border-radius:0 0 var(--radius-md) var(--radius-md)">'
      + '<div style="padding:var(--space-4);background:color-mix(in srgb, var(--color-sacred) 4%, transparent);border-left:2px solid var(--color-sacred);border-radius:0 var(--radius-sm) var(--radius-sm) 0;font-family:var(--font-prayer);font-size:var(--text-base);color:var(--color-text-primary);line-height:2.0;font-style:italic">'
      + '<p style="margin-bottom:var(--space-4)">O Most Holy Virgin Mary, tender Mother of men, to fulfill the desires of the Sacred Heart of Jesus and the request of the Vicar of Your Son on earth, we consecrate ourselves and our families to your Sorrowful and Immaculate Heart, O Queen of the Most Holy Rosary.</p>'
      + '<p>Please accept our consecration, dearest Mother, and use us as you wish to accomplish your designs in the world. O Immaculate Heart of Mary, Queen of Heaven and earth, rule over us and teach us how to make the Heart of Jesus reign and triumph in us and around us, as it has reigned and triumphed in you. <strong style="font-style:normal">Amen.</strong></p>'
      + '</div></div></details>'
