...
function renderMore() {
  ...
  if (whSection && hasAnyEvents) {
    ...
    document.getElementById('whCommunityList').innerHTML = commShow.length ? commShow.map(function(e, idx) {
      ...
      return '<div class="wh-event-card" onclick="openDetail(\'' + e.churchId + '\')">'
        + near
